...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-6 w-6 text-warning-600 dark:text-warning-500 mt-0.5']); ?>
...
<?php endif; ?>
            <div class="flex-1">
                <h3 class="font-bold text-warning-700 dark:text-warning-500">
                    Ditemukan <?php echo e($count); ?> Nomor Inventaris Duplikat
                </h3>
                <p class="text-sm text-warning-700/80 dark:text-warning-400 mt-1">
                    Nomor inventaris berikut sudah ada di database.
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($this->data['policy'] ?? 'skip') === 'skip'): ?>
                        Data ini akan <strong>dilewati (skip)</strong> secara otomatis.
                    <?php elseif(($this->data['policy'] ?? 'skip') === 'overwrite'): ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-6 w-6 text-success-600 dark:text-success-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH D:\Informatika V2\INVENTARIS MIPA\Inven-RT\simarut_lastest\resources\views/filament/import/preview-summary.blade.php ENDPATH**/ ?>