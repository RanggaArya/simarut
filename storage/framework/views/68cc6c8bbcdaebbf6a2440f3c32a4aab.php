  ...
  <div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
      ...
      <div
        ...
        <p class="text-[10px] text-gray-400 mt-2 flex items-center gap-1">
          <span>*Biaya awal: Rp <?php echo e(number_format($record->harga_beli, 0, ',', '.')); ?></span>
        </p>
      </div>
      ...
      <div
        ...
        <?php elseif($record->sisa_masa_pakai <= 0): ?>
          <p class="text-xl font-bold text-gray-400 line-through decoration-red-500/50">
            Rp <?php echo e(number_format($penyusutan_per_bulan, 0, ',', '.')); ?>
      ...
      <div
        class="p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm relative overflow-hidden <?php echo e($residuBg); ?>">
        ...
        <?php else: ?>
          ...
          <p class="text-[10px] text-emerald-600/70 dark:text-emerald-400/70 mt-2 leading-tight">
            *Total penyusutan: Rp <?php echo e(number_format($record->total_penyusutan, 0, ',', '.')); ?>
    ...
    <div class="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
      <div class="flex justify-between items-end mb-2">
        ...
        <?php else: ?>
          <span class="text-blue-600 dark:text-blue-400 font-bold text-sm"><?php echo e($record->sisa_masa_pakai); ?> Bulan
            Tersisa</span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </div>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->is_kena_penyusutan): ?>
        <div
          ...
          <div
            class="<?php echo e($record->sisa_masa_pakai <= 0 ? 'bg-red-500' : 'bg-gradient-to-r from-blue-500 to-indigo-500'); ?> h-3 transition-all duration-500 ease-out relative"
        ...
        <div class="flex justify-between text-[11px] font-medium text-gray-500 dark:text-gray-400">
          <span>Telah terpakai: <strong class="text-gray-800 dark:text-gray-200"><?php echo e($record->bulan_terpakai); ?>

              Bulan</strong> (<?php echo e($persentase_terpakai); ?>%)</span>
          <span>Total: <strong class="text-gray-800 dark:text-gray-200"><?php echo e($record->masa_pakai_aktif); ?>
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="<?php echo e($rowClass); ?>">
                  <td class="px-4 py-2.5 text-center relative">
                    ...
                    <span
                      class="inline-flex items-center justify-center w-7 h-7 rounded-full text-xs font-bold transition-colors <?php echo e($badgeClass); ?>">
                  ...
                  <td
                    class="px-4 py-2.5 text-right font-bold <?php echo e($row['nilai_aset'] == 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-gray-100'); ?>">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-bold text-lg text-gray-900 dark:text-white leading-tight">
                  <?php echo e(\Carbon\Carbon::parse($record->tanggal_supervisi_aktif)->translatedFormat('d F Y')); ?>
