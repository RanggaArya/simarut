<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-0 border-b border-gray-100 dark:border-gray-700">
    <div
      class="p-6 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
      ...
      <div class="col-span-2">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$record->is_kena_penyusutan): ?>
          ...
          <div class="mt-1 flex items-start gap-1">
            ...
            <p class="text-[10px] text-yellow-600 dark:text-yellow-500 font-medium leading-tight">
              Aset Ekstrakomptabel (Di bawah batas kapitalisasi Rp 2.000.000). <br>Nilai aset tetap utuh dan tidak
