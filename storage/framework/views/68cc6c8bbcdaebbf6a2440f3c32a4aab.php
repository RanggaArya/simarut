<div
      ...
      <div class="w-full md:w-auto">
        <div class="flex items-center gap-2 mb-2">
          <span class="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-widest text-rose-200/80">
            ...
            <?php echo e($record->kategori->nama_kategori ?? 'Kategori Umum'); ?>
        ...
        <div
          ...
          <span
            ...
            <?php echo e($record->nomor_inventaris ?? 'BELUM-ADA-NOMOR'); ?>
  ...
  <div
    ...
    <div
      ...
      <p class="mt-3 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($record->lokasi->nama_lokasi ?? '-'); ?>
    ...
    <div
      ...
      <p class="mt-3 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($record->jenis->nama_jenis ?? '-'); ?></p>
    </div>
    ...
    <div class="p-6 hover:bg-white dark:hover:bg-[#1a0e0e] transition duration-300">
      ...
      <p class="mt-3 text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($record->merek_alat ?? '-'); ?></p>
    </div>
  ...
  <div class="p-6 md:p-8">
    ...
    <div
      ...
      <div>
        <p class="text-[10px] font-bold text-gray-500 dark:text-rose-200/50 uppercase tracking-widest mb-1.5">Tahun
          Pengadaan</p>
        <p class="font-semibold text-gray-900 dark:text-gray-200 text-sm"><?php echo e($record->tahun_pengadaan ?? '-'); ?></p>
      </div>
      <div>
        <p class="text-[10px] font-bold text-gray-500 dark:text-rose-200/50 uppercase tracking-widest mb-1.5">Sumber
          Pendanaan</p>
        <p class="font-semibold text-gray-900 dark:text-gray-200 text-sm"><?php echo e($record->sumber_pendanaan ?? '-'); ?></p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
      <div
        ...
        <p class="text-2xl font-extrabold text-gray-900 dark:text-white">Rp
          <?php echo e(number_format($record->harga_total ?? $record->harga_beli, 0, ',', '.')); ?>

        </p>
        <p class="text-[11px] text-gray-400 dark:text-gray-500 mt-2 font-medium">Biaya awal: Rp
          <?php echo e(number_format($record->harga_beli, 0, ',', '.')); ?>
      ...
      <div
        ...
        <?php elseif($record->sisa_masa_pakai <= 0): ?>
          <p class="text-2xl font-bold text-gray-400 dark:text-gray-600 line-through decoration-red-500/50">Rp
            <?php echo e(number_format($penyusutan_per_bulan, 0, ',', '.')); ?>
      ...
      ?>
      <div class="p-5 rounded-2xl border shadow-sm relative overflow-hidden <?php echo e($residuBg); ?> transition-all">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$record->is_kena_penyusutan): ?>
          <p class="text-3xl font-black text-gray-800 dark:text-white">Rp
            <?php echo e(number_format($record->harga_total ?? $record->harga_beli ?? 0, 0, ',', '.')); ?>
    ...
    <div
      ...
      <div class="flex justify-between items-end mb-3">
        ...
        <?php else: ?>
          <span
            class="text-emerald-600 dark:text-emerald-500 font-extrabold text-sm uppercase tracking-wide"><?php echo e($record->sisa_masa_pakai); ?>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->is_kena_penyusutan): ?>
        <div
          ...
          <div
            class="<?php echo e($record->sisa_masa_pakai <= 0 ? 'bg-rose-600' : 'bg-gradient-to-r from-blue-500 to-indigo-500'); ?> h-full transition-all duration-1000 ease-out relative"
            style="width: <?php echo e($persentase_terpakai); ?>%">
            <div
        ...
        <div class="flex justify-between text-[11px] font-semibold text-gray-500 dark:text-gray-400">
          <span>Terpakai: <strong class="text-gray-900 dark:text-rose-100"><?php echo e($record->bulan_terpakai); ?> Bulan</strong>
            (<?php echo e($persentase_terpakai); ?>%)</span>
          <span>Target Total: <strong class="text-gray-900 dark:text-rose-100"><?php echo e($record->masa_pakai_aktif); ?>
  ...
  <div
    ...
    <div class="flex items-center justify-between mb-5">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->is_kena_penyusutan && $record->bulan_terpakai > 0): ?>
        <span
          ...
          <?php echo e(min($record->bulan_terpakai, $record->masa_pakai_aktif)); ?> Bulan Tercatat
        </span>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <?php else: ?>
        ...
        <div class="max-h-[350px] overflow-y-auto custom-scrollbar relative">
          <table class="min-w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-rose-900/20">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                  $isLast = $loop->last;
                ...
                <tr class="<?php echo e($rowClass); ?>">
                  <td class="px-5 py-3 text-center relative">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLast && !$isSelesai): ?>
                      <span class="absolute left-0 top-0 bottom-0 w-1.5 bg-emerald-500 rounded-r-md"></span>
                    <?php elseif($isLast && $isSelesai): ?>
                      <span class="absolute left-0 top-0 bottom-0 w-1.5 bg-rose-600 rounded-r-md"></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span
                      class="inline-flex items-center justify-center w-7 h-7 rounded-lg text-xs font-bold transition-colors <?php echo e($badgeClass); ?>">
                      <?php echo e($row['bulan_ke']); ?>
                  ...
                  <td class="px-5 py-3 text-right font-bold text-amber-600 dark:text-amber-500">
                    - Rp <?php echo e(number_format($row['depresiasi'], 0, ',', '.')); ?>

                  </td>
                  <td
                    class="px-5 py-3 text-right font-black <?php echo e($row['nilai_aset'] == 0 ? 'text-rose-600 dark:text-rose-500' : 'text-gray-900 dark:text-white'); ?>">
                    Rp <?php echo e(number_format($row['nilai_aset'], 0, ',', '.')); ?>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->bulan_terpakai >= $record->masa_pakai_aktif): ?>
        <div
  ...
  <div class="p-6 md:p-8 bg-white dark:bg-[#140b0b]">
    ...
    <?php else: ?>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        <div
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->tanggal_supervisi_aktif): ?>
            <div class="flex items-center gap-4">
              ...
              <div>
                <p class="font-extrabold text-xl text-gray-900 dark:text-white leading-tight">
                  <?php echo e(\Carbon\Carbon::parse($record->tanggal_supervisi_aktif)->translatedFormat('d M Y')); ?>
    ...
    <div
      ...
      <div class="flex items-center justify-between border-b border-gray-200 dark:border-rose-900/30 pb-4 mb-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($riwayatSupervisi->isNotEmpty()): ?>
          <span
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($riwayatSupervisi->isEmpty()): ?>
        <div
          class="flex flex-col items-center justify-center py-10 px-4 text-center border border-dashed border-gray-300 dark:border-rose-900/30 rounded-2xl bg-white dark:bg-[#160c0c]">
      ...
      <?php else: ?>
        <div class="max-h-[350px] overflow-y-auto pr-4 custom-scrollbar relative">
          <div
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $riwayatSupervisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $riwayat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="relative group">
                <div
                  ...
                  <span
                    class="w-2 h-2 rounded-full bg-emerald-500 dark:bg-emerald-400 <?php echo e($loop->first ? 'animate-pulse' : ''); ?>"></span>
                </div>
                  ...
                  <div
                    ...
                    <div class="flex items-center gap-2">
                      <span
                        ...
                        <?php echo e(\Carbon\Carbon::parse($riwayat->tanggal)->translatedFormat('l, d F Y')); ?>
                    ...
                    <div
                      ...
                      Oleh: <span
                        class="text-gray-700 dark:text-rose-100"><?php echo e($riwayat->user->name ?? 'User Sistem'); ?></span>
                    </div>
                  </div>
                  <div class="pl-1">
                    ...
                    <div class="text-sm text-gray-700 dark:text-gray-300 font-medium leading-relaxed italic">
                      <?php echo e($riwayat->keterangan ?? 'Tidak ada catatan tambahan.'); ?>
  ...
  <div x-data="{ activeTab: 'mutasi', isImageModalOpen: false, modalImageUrl: '' }" class="p-6 md:p-8 bg-white dark:bg-[#140b0b] border-t border-gray-200 dark:border-rose-900/30">
    ...
    <div x-show="activeTab === 'mutasi'" x-transition:enter="transition ease-out duration-300" style="display: none;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mutasis->isEmpty()): ?>
        ...
        <?php else: ?>
            <div class="max-h-[350px] overflow-y-auto custom-scrollbar pr-2 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mutasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mutasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $alasanMutasi = is_array($mutasi->alasan_mutasi) ? implode(', ', $mutasi->alasan_mutasi) : $mutasi->alasan_mutasi; ?>
                    <div class="group relative p-5 rounded-2xl border border-gray-200 dark:border-rose-900/40 bg-gray-50/80 dark:bg-[#180d0d] hover:border-rose-400 transition-all shadow-sm">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="px-3 py-1.5 rounded-lg bg-white dark:bg-black/60 text-xs font-extrabold text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-700 shadow-sm"><?php echo e($mutasi->lokasiAsal->nama_lokasi ?? 'Lokasi Awal'); ?></span>
                                </div>
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <?php $namaTujuan = \App\Models\Lokasi::find($mutasi->lokasi_mutasi_id)?->nama_lokasi ?? 'N/A'; ?>
                                    <span class="px-3 py-1.5 rounded-lg bg-gradient-to-r from-rose-600 to-rose-700 text-white text-xs font-extrabold shadow-md"><?php echo e($namaTujuan); ?></span>
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-6 text-right bg-white dark:bg-black/40 p-3 rounded-xl border border-gray-200 dark:border-rose-900/20 shadow-sm">
                                <div>
                                    ...
                                    <p class="text-xs font-extrabold text-gray-900 dark:text-white"><?php echo e(\Carbon\Carbon::parse($mutasi->tanggal_mutasi)->format('d/m/Y')); ?></p>
                                </div>
                                <div>
                                    <p class="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase mb-1">Diterima</p>
                                    <p class="text-xs font-extrabold <?php echo e($mutasi->tanggal_diterima ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'); ?>"><?php echo e($mutasi->tanggal_diterima ? \Carbon\Carbon::parse($mutasi->tanggal_diterima)->format('d/m/Y') : 'Menunggu'); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 border-t border-gray-200 dark:border-rose-900/30 pt-3">
                            ...
                            <p class="text-xs text-gray-800 dark:text-gray-200 font-medium italic">"<?php echo e($alasanMutasi ?? 'Tidak ada keterangan tertulis.'); ?>"</p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <div x-show="activeTab === 'pinjam'" x-transition:enter="transition ease-out duration-300" style="display: none;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peminjamans->isEmpty()): ?>
            <p class="text-center py-10 text-xs text-gray-500 font-bold uppercase tracking-widest">Aset belum pernah dipinjam.</p>
        <?php else: ?>
            <div class="max-h-[350px] overflow-y-auto custom-scrollbar pr-2 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $peminjamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pinjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $alasanPinjam = is_array($pinjam->alasan_pinjam) ? implode(', ', $pinjam->alasan_pinjam) : $pinjam->alasan_pinjam; ?>
                    <div class="p-5 rounded-2xl border border-gray-200 dark:border-rose-900/40 bg-gray-50/80 dark:bg-[#180d0d] hover:border-rose-400 transition-all shadow-sm">
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex items-center gap-3">
                                <?php $namaPeminjam = $pinjam->pihak_kedua_nama ?? 'Pihak Luar'; ?>
                                <div class="w-11 h-11 rounded-full bg-gradient-to-br from-rose-100 to-rose-200 dark:from-rose-900/60 dark:to-red-900/40 flex items-center justify-center text-rose-800 dark:text-rose-300 font-black text-lg shadow-inner border border-rose-300 dark:border-rose-700"><?php echo e(strtoupper(substr($namaPeminjam, 0, 1))); ?></div>
                                <div>
                                    <p class="text-sm font-black text-gray-900 dark:text-white"><?php echo e($namaPeminjam); ?></p>
                                    <?php $namaApprover = \App\Models\User::find($pinjam->approved_by_user_id)?->name ?? 'System/Pending'; ?>
                                    <p class="text-[10px] text-gray-600 dark:text-gray-400 uppercase tracking-wider font-extrabold mt-0.5">Approved by: <span class="text-rose-600 dark:text-rose-400"><?php echo e($namaApprover); ?></span></p>
                                </div>
                            </div>
                            <span class="px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm <?php echo e(strtolower($pinjam->status) == 'kembali' ? 'bg-emerald-100 text-emerald-800 border border-emerald-300' : 'bg-amber-100 text-amber-800 border border-amber-300 animate-pulse'); ?>"><?php echo e($pinjam->status ?? 'Aktif'); ?></span>
                        </div>
                        <div class="grid grid-cols-2 gap-6 bg-white dark:bg-black/40 p-4 rounded-xl mb-4 border border-gray-200 dark:border-rose-900/20 shadow-sm">
                            <div>
                                ...
                                <p class="text-xs font-extrabold text-gray-900 dark:text-white"><?php echo e(\Carbon\Carbon::parse($pinjam->tanggal_mulai)->translatedFormat('d M Y')); ?></p>
                            </div>
                            <div>
                                ...
                                <p class="text-xs font-extrabold text-gray-900 dark:text-white"><?php echo e($pinjam->tanggal_selesai ? \Carbon\Carbon::parse($pinjam->tanggal_selesai)->translatedFormat('d M Y') : '-'); ?></p>
                            </div>
                        </div>
                        <div class="px-2 pt-2 border-t border-gray-200 dark:border-rose-900/30">
                            ...
                            <p class="text-xs text-gray-800 dark:text-gray-200 font-semibold italic">"<?php echo e($alasanPinjam ?? '-'); ?>"</p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <div x-show="activeTab === 'tarik'" x-transition:enter="transition ease-out duration-300" style="display: none;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($penarikans->isEmpty()): ?>
            <p class="text-center py-10 text-xs text-gray-500 font-bold uppercase tracking-widest">Tidak ada riwayat penarikan.</p>
        <?php else: ?>
            <div class="max-h-[350px] overflow-y-auto custom-scrollbar pr-2 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $penarikans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="relative overflow-hidden p-6 rounded-2xl border border-red-300 dark:border-red-900/50 bg-gradient-to-br from-red-50 to-white dark:from-[#1f0d0d] dark:to-[#140808] shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div class="flex items-center gap-4 mb-6 relative z-10">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] font-bold text-red-900/70 dark:text-red-300/70 mt-1">Dieksekusi pada: <span class="text-red-700 dark:text-red-400"><?php echo e(\Carbon\Carbon::parse($tarik->tanggal_penarikan)->translatedFormat('d F Y')); ?></span></p>
                            </div>
                        </div>
                        <div class="space-y-5 bg-white/70 dark:bg-black/40 p-5 rounded-xl border border-red-200/60 dark:border-red-900/30 relative z-10 shadow-sm">
                            <div>
                                ...
                                <p class="text-sm font-extrabold text-gray-900 dark:text-gray-100 ml-3.5"><?php echo e($alasanTarik ?? '-'); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($catatanTarik): ?>
                                    <p class="text-xs text-gray-700 dark:text-gray-300 italic mt-2 ml-3.5 border-l-[3px] border-red-300 dark:border-red-800 pl-3 font-medium">Catatan: "<?php echo e($catatanTarik); ?>"</p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="pt-4 border-t border-red-200 dark:border-red-900/40">
                                ...
                                <p class="text-xs font-bold text-gray-800 dark:text-gray-200 ml-3.5 leading-relaxed"><?php echo $tipeHtml; ?> <span class="mt-1 block"><?php echo e($detailTindakLanjut ?? 'Belum ada detail tindak lanjut dari manajemen.'); ?></span></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div x-show="activeTab === 'maintenance'" x-transition:enter="transition ease-out duration-300" style="display: none;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maintenances->isEmpty()): ?>
        ...
        <?php else: ?>
            ...
            <div class="max-h-[450px] overflow-y-auto custom-scrollbar pr-2 space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $maintenances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-data="{ expanded: false }" class="bg-white dark:bg-[#160c0c] border border-gray-300 dark:border-rose-900/50 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div @click="expanded = !expanded" class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 p-4 md:px-5 cursor-pointer bg-gray-50/80 dark:bg-black/20 hover:bg-gray-100 dark:hover:bg-black/40 transition-colors group">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-base text-gray-900 dark:text-white"><?php echo e($mnt->tanggal_maintenance ? \Carbon\Carbon::parse($mnt->tanggal_maintenance)->translatedFormat('l, d F Y') : '-'); ?></p>
                                    <p class="text-[10px] font-black uppercase tracking-widest text-gray-500 mt-1">Pemilik/Pengguna: <span class="text-rose-600 dark:text-rose-400"><?php echo e($mnt->nama_pemilik ?? '-'); ?></span></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end mt-2 md:mt-0">
                                ...
                                ?>
                                <span class="px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border shadow-sm <?php echo e($statusClass); ?>">
                        ...
                        <div x-show="expanded" x-collapse x-cloak>
                            <div class="p-5 md:p-6 grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-gray-200 dark:border-rose-900/30">
                                ...
                                <div class="md:col-span-2 space-y-5">
                                    <div>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $mnt->maintenanceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <span class="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 text-xs font-bold rounded-md border border-gray-300 dark:border-gray-600 shadow-sm">
                                                    <?php echo e($type->nama ?? $type->name ?? 'Tipe Umum'); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="bg-indigo-50/80 dark:bg-indigo-950/30 p-4 rounded-xl border border-indigo-200 dark:border-indigo-900/50 shadow-sm">
                                            <p class="text-xs font-bold text-indigo-900 dark:text-indigo-200 leading-relaxed">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mnt->komponen_summary): ?>
                                                    <?php echo nl2br(e($mnt->komponen_summary)); ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-900 dark:text-white font-bold bg-gray-50 dark:bg-black/40 p-4 rounded-xl border border-gray-200 dark:border-rose-900/20 shadow-inner leading-relaxed">
                                            <?php echo e($mnt->deskripsi ?? 'Tidak ada deskripsi rinci.'); ?>

                                        </p>
                                    </div>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mnt->catatan): ?>
                                    <div class="pt-2 border-t border-gray-200 dark:border-rose-900/30">
                                        ...
                                        <p class="text-xs text-gray-700 dark:text-gray-300 font-bold italic border-l-[3px] border-amber-400 dark:border-amber-600 pl-3">"<?php echo e($mnt->catatan); ?>"</p>
                                    </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="md:col-span-1 border-t md:border-t-0 md:border-l border-gray-200 dark:border-rose-900/30 pt-5 md:pt-0 md:pl-5">
                                    ...
                                    <?php $fotos = is_array($mnt->foto) ? $mnt->foto : []; ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($fotos) > 0): ?>
                                        <div class="flex flex-wrap gap-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div @click="isImageModalOpen = true; modalImageUrl = '<?php echo e(\Illuminate\Support\Facades\Storage::url($ft)); ?>'" class="relative w-16 h-16 rounded-xl overflow-hidden border-2 border-gray-300 dark:border-rose-900/50 shadow-sm cursor-pointer hover:ring-2 hover:ring-rose-500 hover:ring-offset-2 dark:hover:ring-offset-[#160c0c] transition-all group/img">
                                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($ft)); ?>" alt="Dokumentasi" class="w-full h-full object-cover group-hover/img:scale-110 transition-transform duration-300">
                            ...
                            <div class="px-6 py-3 bg-gray-100/50 dark:bg-black/60 text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest text-right border-t border-gray-200 dark:border-rose-900/30">
                                Ditambahkan Oleh: <span class="text-rose-600 dark:text-rose-400 ml-1"><?php echo e($mnt->user->name ?? 'Admin Sistem'); ?></span>
                            </div>
                        </div>
  ...
  <div
    ...
    <div class="flex items-center gap-1.5">
      ...
      Dibuat: <span class="text-gray-600 dark:text-gray-300"><?php echo e($record->created_at?->format('d M Y, H:i')); ?></span>
    </div>
    <div class="flex items-center gap-1.5">
      <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      Update: <span class="text-gray-600 dark:text-gray-300"><?php echo e($record->updated_at?->format('d M Y, H:i')); ?></span>
    </div>
  </div>
